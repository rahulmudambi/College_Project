...
public class StartApp {
	...
	public static void displayMainMenu(){
		...
		case 1: 
			...
			boolean exists = model.checkIfCategoryExists(category_name,1);
			if(exists)
			...
			displayTaskMenu(category_name);
			
			break;
		case 2: 
			System.out.println("Enter the Category Name:");
			String category_nam = sc.next();
			boolean exist = model.checkIfCategoryExists(category_nam,2);
			if(exist)
				System.out.println("No Such Category....");
			else
				displayTaskMenu(category_nam);
	...
	private static void displayTaskMenu(String catName)
	{
		TodoModel model = new TodoModel();
		Scanner sc = new Scanner(System.in);
		...
		case 1:
			...
			TaskBean newtask = new TaskBean("Testtask","testing....");
			model.addTask(newtask, catName);
			break;
		case 2:
			break;
		case 3:
